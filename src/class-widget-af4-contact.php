 ...
 *
 * @link       https://github.com/AgriLife/af4-extension-unit/blob/master/src/class-widget-af4-contact.php
 * @since      0.1.0
 ...
 * @since 0.1.0
 */
class Widget_AF4_Contact extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'agrilife_contact', __( 'Contact Us' ), $widget_ops, $control_ops );
	...
	public function form( $instance ) {
		...
		echo wp_kses(
			sprintf(
				...
				esc_attr_e( 'Title:', 'af4-extension-unit' ),
				esc_attr( $this->get_field_id( 'title' ) ),
